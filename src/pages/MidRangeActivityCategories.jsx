...
const activities = [
  { id: 1, title: 'Annapurna Circuit Trek', cat: 'Trekking', rating: 4.9, priceRange: '$350–$500', duration: '14 Days', location: 'Annapurna Region', image: 'https://upload.wikimedia.org/wikipedia/commons/c/c5/Nepal_Annapurna_circuis_%2848020310072%29.jpg', desc: 'One of the world\'s greatest treks, circling the Annapurna massif through diverse landscapes.' },
  { id: 2, title: 'Pokhara Paragliding', cat: 'Adventure', rating: 4.9, priceRange: '$80–$100', duration: 'Half Day', location: 'Sarangkot, Pokhara', image: 'https://upload.wikimedia.org/wikipedia/commons/a/a3/Paragliding_in_Pokhara.jpg', desc: 'Soar over Phewa Lake with spectacular views of the Annapurna and Dhaulagiri ranges.' },
  { id: 3, title: 'Yoga & Meditation Retreat', cat: 'Wellness', rating: 4.8, priceRange: '$120–$200', duration: '3–5 Days', location: 'Kathmandu / Pokhara', image: 'https://upload.wikimedia.org/wikipedia/commons/c/ce/Three_saddhus_at_Kathmandu_Durbar_Square.jpg', desc: 'Reconnect with yourself through guided yoga, pranayama, and meditation in peaceful Himalayan surroundings.' },
  { id: 4, title: 'Cultural Heritage Tour', cat: 'Cultural', rating: 4.7, priceRange: '$120–$180', duration: '3 Days', location: 'Kathmandu Valley', image: 'https://upload.wikimedia.org/wikipedia/commons/8/89/Patan_durbar_square.jpg', desc: 'A curated tour of all seven UNESCO World Heritage monuments in the Kathmandu Valley.' },
  { id: 5, title: 'Chitwan Wildlife Experience', cat: 'Wildlife', rating: 4.8, priceRange: '$150–$250', duration: '3 Days', location: 'Chitwan', image: 'https://upload.wikimedia.org/wikipedia/commons/4/45/Indian_rhinoceros_(Rhinoceros_unicornis)_6.jpg', desc: 'Comprehensive wildlife package including jeep safari, canoe ride, elephant bathing, and cultural dances.' },
  { id: 6, title: 'Upper Mustang Jeep Safari', cat: 'Adventure', rating: 4.9, priceRange: '$400–$600', duration: '7 Days', location: 'Mustang', image: 'https://upload.wikimedia.org/wikipedia/commons/1/17/Jharkot_Village-Upper_Mustang_Trek-1281.jpg', desc: 'Explore the ancient Tibetan-influenced kingdom of Mustang by 4WD jeep across dramatic desert landscapes.' },
  { id: 7, title: 'Annapurna Base Camp Trek', cat: 'Trekking', rating: 4.9, priceRange: '$400–$550', duration: '10 Days', location: 'Annapurna Region', image: 'https://upload.wikimedia.org/wikipedia/commons/6/6e/Annapurna_Base_Camp_2019.jpg', desc: 'Trek through rhododendron forests and Gurung villages to the amphitheatre of peaks at Annapurna Base Camp.' },
  { id: 8, title: 'Langtang Valley Trek', cat: 'Trekking', rating: 4.8, priceRange: '$300–$450', duration: '7 Days', location: 'Langtang Region', image: 'https://upload.wikimedia.org/wikipedia/commons/8/84/Starry_night_in_Langtang_National_Park.jpg', desc: 'A rewarding trek through Tamang villages and alpine meadows in Nepal\'s closest national park to Kathmandu.' },
];
