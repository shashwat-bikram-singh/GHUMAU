...
const restaurants = [
  { id: 1, name: 'Roadside Momo Stall', location: 'Thamel, Kathmandu', type: 'Street Food', price: '$1–3', rating: 4.7, image: 'https://upload.wikimedia.org/wikipedia/commons/f/f4/Namche_Bazaar_Nepal.jpg', desc: 'Authentic street momos — steamed or fried dumplings stuffed with vegetables or meat, best eaten with achar.' },
  { id: 2, name: 'Lakeside Food Street', location: 'Lakeside, Pokhara', type: 'Street Food', price: '$2–5', rating: 4.6, image: 'https://upload.wikimedia.org/wikipedia/commons/8/89/Patan_durbar_square.jpg', desc: 'An entire street of cheap, delicious food stalls by Phewa Lake — try the sekuwa and chatamari.' },
  { id: 3, name: 'Chitwan Thakali House', location: 'Sauraha, Chitwan', type: 'Nepali', price: '$2–4', rating: 4.8, image: 'https://upload.wikimedia.org/wikipedia/commons/b/b7/Phewa_lake%2C_Pokhara.jpg', desc: 'An authentic Thakali kitchen serving unlimited dal bhat at rock-bottom prices beloved by trekkers.' },
  { id: 4, name: 'Bodhi Café', location: 'Boudhha, Kathmandu', type: 'Café', price: '$2–5', rating: 4.5, image: 'https://upload.wikimedia.org/wikipedia/commons/9/9a/Pokhara_Valley.jpg', desc: 'A peaceful café near Boudhanath Stupa, popular for its strong Nepali milk tea, homemade cakes, and serene vibe.' },
  { id: 5, name: 'Bhaktapur Juju Dhau', location: 'Bhaktapur', type: 'Traditional', price: '$1–2', rating: 4.9, image: 'https://upload.wikimedia.org/wikipedia/commons/3/34/Thamel_at_night_-_Kathmandu%2C_Nepal_-_panoramio_%281%29.jpg', desc: 'Try Bhaktapur\'s famous "King Curd" (Juju Dhau) — a rich, creamy yoghurt served in clay pots. A must-try.' },
  { id: 6, name: 'Trekkers Kitchen', location: 'Namche Bazaar, Everest', type: 'Nepali', price: '$5–9', rating: 4.8, image: 'https://upload.wikimedia.org/wikipedia/commons/b/b2/Annapurna_Massif_Aerial_View.jpg', desc: 'Fuel up for the trail with hearty dal bhat, egg noodle soup, and Sherpa stew at this beloved teahouse.' },
];
