...
const restaurants = [
  { id: 1, name: 'Roadside Momo Stall', location: 'Thamel, Kathmandu', type: 'Street Food', price: '$1–3', rating: 4.7, image: 'https://upload.wikimedia.org/wikipedia/commons/a/a1/Momo_nepal.jpg', desc: 'Authentic street momos — steamed or fried dumplings stuffed with vegetables or meat, best eaten with achar.' },
  { id: 2, name: 'Lakeside Food Street', location: 'Lakeside, Pokhara', type: 'Street Food', price: '$2–5', rating: 4.6, image: 'https://upload.wikimedia.org/wikipedia/commons/b/b7/Phewa_lake%2C_Pokhara.jpg', desc: 'An entire street of cheap, delicious food stalls by Phewa Lake — try the sekuwa and chatamari.' },
  { id: 3, name: 'Chitwan Thakali House', location: 'Sauraha, Chitwan', type: 'Nepali', price: '$2–4', rating: 4.8, image: 'https://upload.wikimedia.org/wikipedia/commons/6/60/Nepali_dal-bhat-tarkari.jpg', desc: 'An authentic Thakali kitchen serving unlimited dal bhat at rock-bottom prices beloved by trekkers.' },
  { id: 4, name: 'Bodhi Café', location: 'Boudhha, Kathmandu', type: 'Café', price: '$2–5', rating: 4.5, image: 'https://upload.wikimedia.org/wikipedia/commons/4/4d/Boudhanath_stupa_%2C_Kathmandu%2C_Nepal.jpg', desc: 'A peaceful café near Boudhanath Stupa, popular for its strong Nepali milk tea, homemade cakes, and serene vibe.' },
  { id: 5, name: 'Bhaktapur Juju Dhau', location: 'Bhaktapur', type: 'Traditional', price: '$1–2', rating: 4.9, image: 'https://upload.wikimedia.org/wikipedia/commons/b/bd/Juju_Dhau.jpg', desc: 'Try Bhaktapur\'s famous "King Curd" (Juju Dhau) — a rich, creamy yoghurt served in clay pots. A must-try.' },
  { id: 6, name: 'Trekkers Kitchen', location: 'Namche Bazaar, Everest', type: 'Nepali', price: '$5–9', rating: 4.8, image: 'https://upload.wikimedia.org/wikipedia/commons/f/f4/Namche_Bazaar_Nepal.jpg', desc: 'Fuel up for the trail with hearty dal bhat, egg noodle soup, and Sherpa stew at this beloved teahouse.' },
  { id: 7, name: 'Sam\'s One Tree Café', location: 'Thamel, Kathmandu', type: 'Café', price: '$2–5', rating: 4.6, image: 'https://upload.wikimedia.org/wikipedia/commons/f/f4/Coffee_Himalayan_Java_Nepal.jpg', desc: 'A longtime Thamel favourite for budget breakfasts, pancakes, and strong Nepali coffee in a leafy courtyard.' },
  { id: 8, name: 'Sauraha Street Dhaba', location: 'Sauraha, Chitwan', type: 'Nepali', price: '$2–4', rating: 4.5, image: 'https://upload.wikimedia.org/wikipedia/commons/8/82/Chitwan_swamp.jpg', desc: 'Simple riverside dhabas serving fresh dal bhat and grilled fish after a day in Chitwan National Park.' },
];
