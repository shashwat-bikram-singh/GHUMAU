...
const hotels = [
  { id: 1, name: 'Dwarika\'s Hotel', area: 'Battisputali', stars: 5, rating: 4.9, price: 180, amenities: ['Heritage Rooms', 'Pool', 'Spa', 'Free WiFi'], image: 'https://upload.wikimedia.org/wikipedia/commons/f/fd/Basantapurpalace.JPG', desc: 'A UNESCO-award-winning hotel celebrating Nepal\'s artistic heritage with exquisite medieval architecture.' },
  { id: 2, name: 'Yak & Yeti Hotel', area: 'Durbar Marg', stars: 5, rating: 4.8, price: 155, amenities: ['Casino', 'Spa', 'Garden', 'Free WiFi'], image: 'https://upload.wikimedia.org/wikipedia/commons/3/34/Thamel_at_night_-_Kathmandu%2C_Nepal_-_panoramio_%281%29.jpg', desc: 'A landmark hotel housed in a restored palace with lush gardens in the prestigious Durbar Marg area.' },
  { id: 3, name: 'Hotel Shanker', area: 'Lazimpat', stars: 4, rating: 4.6, price: 90, amenities: ['Heritage', 'Pool', 'Breakfast', 'Free WiFi'], image: 'https://upload.wikimedia.org/wikipedia/commons/f/fd/Basantapurpalace.JPG', desc: 'A magnificent 19th-century Rana palace offering heritage luxury with a beautiful outdoor swimming pool.' },
  { id: 4, name: 'Hyatt Regency Kathmandu', area: 'Boudha', stars: 5, rating: 4.7, price: 195, amenities: ['Pool', 'Gym', 'Spa', 'Multiple Restaurants'], image: 'https://upload.wikimedia.org/wikipedia/commons/4/4d/Boudhanath_stupa_%2C_Kathmandu%2C_Nepal.jpg', desc: 'International luxury with Himalayan charm, featuring spectacular mountain views and world-class facilities.' },
