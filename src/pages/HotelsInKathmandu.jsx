...
const hotels = [
  { id: 1, name: 'Dwarika\'s Hotel', area: 'Battisputali', stars: 5, rating: 4.9, price: 180, amenities: ['Heritage Rooms', 'Pool', 'Spa', 'Free WiFi'], image: 'https://images.unsplash.com/photo-1566073771259-6a8506099945?q=80&w=800&auto=format&fit=crop', desc: 'A UNESCO-award-winning hotel celebrating Nepal\'s artistic heritage with exquisite medieval architecture.' },
  { id: 2, name: 'Yak & Yeti Hotel', area: 'Durbar Marg', stars: 5, rating: 4.8, price: 155, amenities: ['Casino', 'Spa', 'Garden', 'Free WiFi'], image: 'https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?q=80&w=800&auto=format&fit=crop', desc: 'A landmark hotel housed in a restored palace with lush gardens in the prestigious Durbar Marg area.' },
  { id: 3, name: 'Hotel Shanker', area: 'Lazimpat', stars: 4, rating: 4.6, price: 90, amenities: ['Heritage', 'Pool', 'Breakfast', 'Free WiFi'], image: 'https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?q=80&w=800&auto=format&fit=crop', desc: 'A magnificent 19th-century Rana palace offering heritage luxury with a beautiful outdoor swimming pool.' },
  { id: 4, name: 'Hyatt Regency Kathmandu', area: 'Boudha', stars: 5, rating: 4.7, price: 195, amenities: ['Pool', 'Gym', 'Spa', 'Multiple Restaurants'], image: 'https://images.unsplash.com/photo-1571896349842-33c89424de2d?q=80&w=800&auto=format&fit=crop', desc: 'International luxury with Himalayan charm, featuring spectacular mountain views and world-class facilities.' },
  { id: 5, name: 'Hotel Tibet', area: 'Lazimpat', stars: 4, rating: 4.5, price: 80, amenities: ['Tibetan Cuisine', 'Garden', 'Free WiFi', 'Bar'], image: 'https://images.unsplash.com/photo-1555854877-bab0e564b8d5?q=80&w=800&auto=format&fit=crop', desc: 'A cultural boutique hotel inspired by Tibetan art with a beautiful garden and authentic cuisine.' },
  { id: 6, name: 'Kathmandu Guest House', area: 'Thamel', stars: 3, rating: 4.4, price: 45, amenities: ['Historic', 'Garden', 'Free WiFi', 'Restaurant'], image: 'https://images.unsplash.com/photo-1523987355523-c7b5b0dd90a7?q=80&w=800&auto=format&fit=crop', desc: 'Kathmandu\'s most famous hotel, a legendary travellers\' institution in the heart of Thamel since 1967.' },
];
