...
const hotels = [
  { id: 1, name: 'Kathmandu Guest House', location: 'Thamel, Kathmandu', rating: 4.5, price: 18, tag: 'Most Popular', amenities: ['Free WiFi', 'Garden', 'Restaurant'], image: 'https://upload.wikimedia.org/wikipedia/commons/e/e4/Latte_and_dark_coffee.jpg', desc: 'One of Kathmandu\'s most iconic budget hotels with a charming garden in the heart of Thamel.' },
  { id: 2, name: 'Pokhara Peace Home', location: 'Lakeside, Pokhara', rating: 4.4, price: 15, tag: 'Best Value', amenities: ['Lake View', 'Free WiFi', 'Terrace'], image: 'https://upload.wikimedia.org/wikipedia/commons/4/4c/Panoramic_view_of_the_Great_Himalayan_Range_from_Dhulikhel%2C_Nepal_in_2025.jpg', desc: 'A cozy homestay-style accommodation just steps from the Lakeside promenade.' },
  { id: 3, name: 'Jungle Base Camp', location: 'Sauraha, Chitwan', rating: 4.6, price: 22, tag: 'Eco Friendly', amenities: ['Safari', 'Breakfast', 'Fan Rooms'], image: 'https://upload.wikimedia.org/wikipedia/commons/d/df/Sunset_flying_above_Himalayas.jpg', desc: 'Basic but charming eco-friendly lodge right at the gates of Chitwan National Park.' },
  { id: 4, name: 'Tibet Peace Guest House', location: 'Boudhha, Kathmandu', rating: 4.3, price: 12, tag: 'Budget Pick', amenities: ['Free WiFi', 'Rooftop', 'Quiet'], image: 'https://upload.wikimedia.org/wikipedia/commons/c/c9/View_of_Bhaktapur_Durbar_Square.jpg', desc: 'Peaceful and affordable rooms near Boudhanath Stupa, perfect for culture seekers.' },
  { id: 5, name: 'Sadhana Guest House', location: 'Thamel, Kathmandu', rating: 4.4, price: 20, tag: '', amenities: ['Free WiFi', 'Hot Shower', 'Common Room'], image: 'https://upload.wikimedia.org/wikipedia/commons/8/82/Chitwan_swamp.jpg', desc: 'Clean and friendly budget guesthouse, well-positioned for exploring Kathmandu\'s main attractions.' },
