...
const activities = [
  { id: 1, title: 'Ghorepani Poon Hill Trek', cat: 'Trekking', rating: 4.8, price: '$95', duration: '4 Days', location: 'Annapurna', image: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?q=80&w=800&auto=format&fit=crop' },
  { id: 2, title: 'Pokhara Paragliding', cat: 'Adventure', rating: 4.9, price: '$85', duration: 'Half Day', location: 'Pokhara', image: 'https://images.unsplash.com/photo-1520113412536-69d67566cb4b?q=80&w=800&auto=format&fit=crop' },
  { id: 3, title: 'Namobuddha Hike & Monastery', cat: 'Cultural', rating: 4.7, price: '$40', duration: '1 Day', location: 'Kavrepalanchok', image: 'https://images.unsplash.com/photo-1518002171953-a080ee817e1f?q=80&w=800&auto=format&fit=crop' },
  { id: 4, title: 'Seti River Gorge Kayaking', cat: 'Water Sports', rating: 4.6, price: '$75', duration: '1 Day', location: 'Pokhara', image: 'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?q=80&w=800&auto=format&fit=crop' },
  { id: 5, title: 'Langtang Valley Trek', cat: 'Trekking', rating: 4.8, price: '$90', duration: '7 Days', location: 'Langtang', image: 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=800&auto=format&fit=crop' },
  { id: 6, title: 'Zip-Line, Pokhara', cat: 'Adventure', rating: 4.9, price: '$60', duration: '2 hrs', location: 'Pokhara', image: 'https://images.unsplash.com/photo-1531366936337-7c912a4589a7?q=80&w=800&auto=format&fit=crop' },
];
