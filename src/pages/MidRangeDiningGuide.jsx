...
const restaurants = [
  { id: 1, name: 'Bhojan Griha', location: 'Dilli Bazar, Kathmandu', cuisine: 'Traditional Newari', priceRange: '$$$', rating: 4.9, image: 'https://upload.wikimedia.org/wikipedia/commons/7/74/Traditional_Nepali_Thali.jpg', desc: 'An exquisite Newari dining experience in a heritage courtyard mansion — featuring live classical music and 22-course set meals.' },
  { id: 2, name: 'Himalayan Java', location: 'Multiple Locations', cuisine: 'Café & Bakery', priceRange: '$$', rating: 4.7, image: 'https://upload.wikimedia.org/wikipedia/commons/f/f4/Coffee_Himalayan_Java_Nepal.jpg', desc: 'Nepal\'s premium coffee brand, offering specialty Himalayan arabica brews, pastries, and reliable WiFi across Kathmandu and Pokhara.' },
  { id: 3, name: 'Rosemary Kitchen', location: 'Thamel, Kathmandu', cuisine: 'Continental', priceRange: '$$$', rating: 4.8, image: 'https://upload.wikimedia.org/wikipedia/commons/8/84/Wood-fired_Pizza_Oven_at_Baronessa_Italian_Restaurant.jpg', desc: 'A charming garden restaurant beloved for its wood-fired pizzas, fresh pastas, and extensive international wine list.' },
  { id: 4, name: 'Moondance Restaurant', location: 'Lakeside, Pokhara', cuisine: 'International', priceRange: '$$', rating: 4.6, image: 'https://upload.wikimedia.org/wikipedia/commons/b/b7/Phewa_lake%2C_Pokhara.jpg', desc: 'A stylish lakeside restaurant with stunning Annapurna views, known for its creative Asian-Western fusion menu and cocktails.' },
  { id: 5, name: 'Fulbari Resort Restaurant', location: 'Pokhara', cuisine: 'Fine Dining', priceRange: '$$$$', rating: 4.9, image: 'https://upload.wikimedia.org/wikipedia/commons/6/61/Annapurna_South,_Himchuli,_Machapuchare_Himal-3794.jpg', desc: 'The finest dining in Pokhara, combining French culinary techniques with fresh Nepali ingredients and breathtaking mountain views.' },
  { id: 6, name: 'Fire & Ice Pizzeria', location: 'Thamel, Kathmandu', cuisine: 'Italian', priceRange: '$$', rating: 4.7, image: 'https://upload.wikimedia.org/wikipedia/commons/8/84/Wood-fired_Pizza_Oven_at_Baronessa_Italian_Restaurant.jpg', desc: 'A Kathmandu legend — thin-crust, wood-fired pizzas made by an Italian owner using imported mozzarella and fresh local toppings.' },
  { id: 7, name: 'Krishnarpan Restaurant', location: 'Dwarika\'s Hotel, Kathmandu', cuisine: 'Traditional Newari', priceRange: '$$$$', rating: 4.9, image: 'https://upload.wikimedia.org/wikipedia/commons/6/60/Nepali_dal-bhat-tarkari.jpg', desc: 'An award-winning multi-course Newari feast served in a heritage setting — up to 22 courses of authentic Nepali cuisine.' },
  { id: 8, name: 'Gaia Restaurant', location: 'Thamel, Kathmandu', cuisine: 'International', priceRange: '$$', rating: 4.6, image: 'https://upload.wikimedia.org/wikipedia/commons/7/74/Traditional_Nepali_Thali.jpg', desc: 'A popular organic restaurant and bakery in Thamel, known for wholesome breakfasts, fresh juices, and healthy international fare.' },
];
