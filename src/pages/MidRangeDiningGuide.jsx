...
const restaurants = [
  { id: 1, name: 'Bhojan Griha', location: 'Dilli Bazar, Kathmandu', cuisine: 'Traditional Newari', priceRange: '$$$', rating: 4.9, image: 'https://upload.wikimedia.org/wikipedia/commons/c/c9/View_of_Bhaktapur_Durbar_Square.jpg', desc: 'An exquisite Newari dining experience in a heritage courtyard mansion — featuring live classical music and 22-course set meals.' },
  { id: 2, name: 'Himalayan Java', location: 'Multiple Locations', cuisine: 'Café & Bakery', priceRange: '$$', rating: 4.7, image: 'https://upload.wikimedia.org/wikipedia/commons/8/82/Chitwan_swamp.jpg', desc: 'Nepal\'s premium coffee brand, offering specialty Himalayan arabica brews, pastries, and reliable WiFi across Kathmandu and Pokhara.' },
  { id: 3, name: 'Rosemary Kitchen', location: 'Thamel, Kathmandu', cuisine: 'Continental', priceRange: '$$$', rating: 4.8, image: 'https://upload.wikimedia.org/wikipedia/commons/f/fa/Ghorepani.jpg', desc: 'A charming garden restaurant beloved for its wood-fired pizzas, fresh pastas, and extensive international wine list.' },
  { id: 4, name: 'Moondance Restaurant', location: 'Lakeside, Pokhara', cuisine: 'International', priceRange: '$$', rating: 4.6, image: 'https://upload.wikimedia.org/wikipedia/commons/f/fd/Basantapurpalace.JPG', desc: 'A stylish lakeside restaurant with stunning Annapurna views, known for its creative Asian-Western fusion menu and cocktails.' },
  { id: 5, name: 'Fulbari Resort Restaurant', location: 'Pokhara', cuisine: 'Fine Dining', priceRange: '$$$$', rating: 4.9, image: 'https://upload.wikimedia.org/wikipedia/commons/8/84/Starry_night_in_Langtang_National_Park.jpg', desc: 'The finest dining in Pokhara, combining French culinary techniques with fresh Nepali ingredients and breathtaking mountain views.' },
  { id: 6, name: 'Fire & Ice Pizzeria', location: 'Thamel, Kathmandu', cuisine: 'Italian', priceRange: '$$', rating: 4.7, image: 'https://upload.wikimedia.org/wikipedia/commons/a/a1/Momo_nepal.jpg', desc: 'A Kathmandu legend — thin-crust, wood-fired pizzas made by an Italian owner using imported mozzarella and fresh local toppings.' },
];
