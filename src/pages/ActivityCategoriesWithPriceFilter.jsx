...
const allActivities = [
  { id: 1, title: 'Annapurna Base Camp Trek', category: 'Trekking', price: 450, priceLabel: '$450', duration: '10 Days', location: 'Annapurna Region', icon: Mountain, image: 'https://upload.wikimedia.org/wikipedia/commons/b/b2/Annapurna_Massif_Aerial_View.jpg', level: 'Mid-Range' },
  { id: 2, title: 'Pokhara Paragliding', category: 'Adventure', price: 85, priceLabel: '$85', duration: 'Half Day', location: 'Sarangkot, Pokhara', icon: Compass, image: 'https://upload.wikimedia.org/wikipedia/commons/9/9a/Pokhara_Valley.jpg', level: 'Mid-Range' },
  { id: 3, title: 'Chitwan Jungle Safari', category: 'Wildlife', price: 120, priceLabel: '$120', duration: '3 Days', location: 'Chitwan National Park', icon: TreePine, image: 'https://upload.wikimedia.org/wikipedia/commons/8/82/Chitwan_swamp.jpg', level: 'Budget' },
  ...
  { id: 6, title: 'White Water Rafting', category: 'Adventure', price: 65, priceLabel: '$65', duration: '1 Day', location: 'Trisuli River', icon: Compass, image: 'https://upload.wikimedia.org/wikipedia/commons/b/b7/Phewa_lake%2C_Pokhara.jpg', level: 'Budget' },
  ...
  { id: 8, title: 'Langtang Valley Trek', category: 'Trekking', price: 300, priceLabel: '$300', duration: '7 Days', location: 'Langtang Region', icon: Mountain, image: 'https://upload.wikimedia.org/wikipedia/commons/b/b2/Annapurna_Massif_Aerial_View.jpg', level: 'Mid-Range' },
];
