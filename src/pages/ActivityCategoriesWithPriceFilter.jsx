...
<div className="flex flex-col md:flex-row gap-4 w-full md:w-[600px]">
...
<div className="relative w-full md:w-1/2">
<select className="w-full appearance-none bg-surface-container-lowest text-on-surface font-headline font-semibold text-lg py-4 pl-6 pr-12 rounded-xl border border-outline-variant/15 focus:outline-none focus:ring-2 focus:ring-surface-tint/50 shadow-[0_4px_30px_rgba(0,0,0,0.03)] cursor-pointer transition-all">
<option selected="" value="all">Any Price</option>
...
<span className="inline-block px-4 py-1 rounded-full bg-surface/20 backdrop-blur-md text-on-primary font-label text-sm uppercase tracking-widest">High Altitude</span>
<span className="inline-block px-4 py-1 rounded-full bg-primary/80 backdrop-blur-md text-on-primary font-label text-sm font-bold tracking-widest">$$</span>
</div>
...
<div className="p-6">
<h4 className="font-headline text-xl font-bold text-on-surface mb-2 flex justify-between items-center">
<span>Namche Bazaar</span>
<span className="text-base font-semibold text-primary bg-primary/10 px-2 py-0.5 rounded">$</span>
</h4>
...
<div className="absolute bottom-0 left-0 p-8 md:p-12 w-full">
<div className="flex flex-wrap gap-2 mb-4">
<span className="inline-block px-4 py-1 rounded-full bg-surface/20 backdrop-blur-md text-on-primary font-label text-sm uppercase tracking-widest">Diverse Terrain</span>
<span className="inline-block px-4 py-1 rounded-full bg-primary/80 backdrop-blur-md text-on-primary font-label text-sm font-bold tracking-widest">$</span>
</div>
