...
const restaurants = [
  { id: 1, name: 'Thamel Momo Corner', location: 'Thamel, Kathmandu', type: 'Street Food', price: '$2–5', rating: 4.8, image: 'https://upload.wikimedia.org/wikipedia/commons/e/e4/Latte_and_dark_coffee.jpg', desc: 'Legendary street-side stall serving piping hot buff and chicken momos — a Kathmandu institution.' },
  { id: 2, name: 'OR2K Restaurant', location: 'Thamel, Kathmandu', type: 'Vegetarian', price: '$4–8', rating: 4.6, image: 'https://upload.wikimedia.org/wikipedia/commons/4/4c/Panoramic_view_of_the_Great_Himalayan_Range_from_Dhulikhel%2C_Nepal_in_2025.jpg', desc: 'A beloved Middle Eastern-Nepali fusion spot popular with backpackers for its hummus, falafels, and dal bhat.' },
  { id: 3, name: 'Pokhara Thakali Kitchen', location: 'Lakeside, Pokhara', type: 'Nepali', price: '$3–6', rating: 4.9, image: 'https://upload.wikimedia.org/wikipedia/commons/d/df/Sunset_flying_above_Himalayas.jpg', desc: 'Authentic Thakali set meals (dal bhat) in generous portions — the preferred meal of Nepal\'s mountain trekkers.' },
  { id: 4, name: 'Chitwan Jungle Café', location: 'Sauraha, Chitwan', type: 'Café', price: '$3–7', rating: 4.5, image: 'https://upload.wikimedia.org/wikipedia/commons/c/c9/View_of_Bhaktapur_Durbar_Square.jpg', desc: 'A relaxed open-air café in the jungle town of Sauraha, perfect for breakfast and sunset drinks.' },
  { id: 5, name: 'Newari Kitchen, Patan', location: 'Patan Durbar Square', type: 'Traditional', price: '$4–8', rating: 4.7, image: 'https://upload.wikimedia.org/wikipedia/commons/8/82/Chitwan_swamp.jpg', desc: 'Authentic Newari cuisine served in a traditional setting overlooking Patan\'s UNESCO World Heritage square.' },
  { id: 6, name: 'Lumbini Pilgrim Dhaba', location: 'Lumbini', type: 'Nepali', price: '$2–4', rating: 4.4, image: 'https://upload.wikimedia.org/wikipedia/commons/f/fa/Ghorepani.jpg', desc: 'A simple, wholesome dhaba near the sacred Lumbini Gardens, serving hearty vegetarian meals and chai.' },
];
