...
const activities = [
  { id: 1, title: 'Chitwan Canoe Ride', duration: '2 hrs', location: 'Chitwan', price: '$8', image: 'https://images.unsplash.com/photo-1530541930197-ff16ac917b0e?q=80&w=800&auto=format&fit=crop', desc: 'Glide silently through the Rapti River in a traditional dugout canoe and spot crocodiles and birds.' },
  { id: 2, title: 'Kathmandu Heritage Walk', duration: '1 Day', location: 'Kathmandu', price: '$25', image: 'https://images.unsplash.com/photo-1518002171953-a080ee817e1f?q=80&w=800&auto=format&fit=crop', desc: 'Walk through Durbar Squares, Boudhanath and Pashupatinath on a fully guided cultural walking tour.' },
  { id: 3, title: 'Trisuli River Rafting', duration: '1 Day', location: 'Trisuli', price: '$55', image: 'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?q=80&w=800&auto=format&fit=crop', desc: 'Navigate exciting Grade III-IV rapids on the beautiful Trisuli River, just 2 hours from Kathmandu.' },
  { id: 4, title: 'Poon Hill Sunrise Trek', duration: '4 Days', location: 'Ghorepani', price: '$90', image: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?q=80&w=800&auto=format&fit=crop', desc: 'A classic short trek to the iconic Poon Hill viewpoint for unforgettable Himalayan sunrise views.' },
  { id: 5, title: 'Jungle Safari (Jeep)', duration: 'Half Day', location: 'Chitwan', price: '$45', image: 'https://images.unsplash.com/photo-1581008697198-5c464817a02c?q=80&w=800&auto=format&fit=crop', desc: 'A thrilling jeep safari through the dense jungle in search of rhinos, elephants, deer and leopards.' },
  { id: 6, title: 'Bhaktapur Day Tour', duration: '1 Day', location: 'Bhaktapur', price: '$30', image: 'https://images.unsplash.com/photo-1508672019048-805c876b67e2?q=80&w=800&auto=format&fit=crop', desc: 'Explore the remarkably preserved medieval city of Bhaktapur with its stunning Durbar Square and Peacock Windows.' },
];
