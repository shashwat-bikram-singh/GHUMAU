...
const hotels = [
  { id: 1, name: 'Hotel Jampa', location: 'Thamel, Kathmandu', rating: 4.6, price: 20, amenities: ['Free WiFi', 'Breakfast', 'Hot Water'], image: 'https://upload.wikimedia.org/wikipedia/commons/9/9a/Pokhara_Valley.jpg', desc: 'Spotlessly clean rooms with modern amenities and warm Nepali hospitality in a prime Thamel location.' },
  { id: 2, name: 'Busy Bee Café & Lodge', location: 'Lakeside, Pokhara', rating: 4.5, price: 18, amenities: ['Free WiFi', 'Café', 'Terrace'], image: 'https://upload.wikimedia.org/wikipedia/commons/3/34/Thamel_at_night_-_Kathmandu%2C_Nepal_-_panoramio_%281%29.jpg', desc: 'A beloved travellers\' lodge with a social café, vibrant notice boards, and easy lake access.' },
  { id: 3, name: 'Trek Stop Guesthouse', location: 'Sauraha, Chitwan', rating: 4.7, price: 25, amenities: ['Breakfast', 'Fan Rooms', 'Bicycle Hire'], image: 'https://upload.wikimedia.org/wikipedia/commons/b/b2/Annapurna_Massif_Aerial_View.jpg', desc: 'Excellent value lodge steps from the jungle, with helpful staff and reliable safari bookings.' },
  { id: 4, name: 'Old Town Inn', location: 'Bhaktapur', rating: 4.8, price: 22, amenities: ['Durbar View', 'Free WiFi', 'Breakfast'], image: 'https://upload.wikimedia.org/wikipedia/commons/e/e4/Latte_and_dark_coffee.jpg', desc: 'Heritage-styled lodge with wooden window frames and views directly onto Bhaktapur\'s Durbar Square.' },
  { id: 5, name: 'Lakeside Homestay', location: 'Lakeside, Pokhara', rating: 4.5, price: 14, amenities: ['Home Cooking', 'Free WiFi', 'Garden'], image: 'https://upload.wikimedia.org/wikipedia/commons/4/4c/Panoramic_view_of_the_Great_Himalayan_Range_from_Dhulikhel%2C_Nepal_in_2025.jpg', desc: 'A genuine Nepali family homestay offering home-cooked meals, warm conversation, and authentic cultural immersion.' },
  { id: 6, name: 'Namche Village Lodge', location: 'Namche Bazaar, Everest', rating: 4.9, price: 12, amenities: ['Mountain View', 'Dal Bhat', 'Hot Water'], image: 'https://upload.wikimedia.org/wikipedia/commons/d/df/Sunset_flying_above_Himalayas.jpg', desc: 'A legendary mountain lodge in the Sherpa capital with sweeping views of Everest and Ama Dablam.' },
];
