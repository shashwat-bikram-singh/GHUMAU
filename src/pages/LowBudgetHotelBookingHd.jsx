...
const hotels = [
  { id: 1, name: 'Hotel Jampa', location: 'Thamel, Kathmandu', rating: 4.6, price: 20, amenities: ['Free WiFi', 'Breakfast', 'Hot Water'], image: 'https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?q=80&w=800&auto=format&fit=crop', desc: 'Spotlessly clean rooms with modern amenities and warm Nepali hospitality in a prime Thamel location.' },
  { id: 2, name: 'Busy Bee Café & Lodge', location: 'Lakeside, Pokhara', rating: 4.5, price: 18, amenities: ['Free WiFi', 'Café', 'Terrace'], image: 'https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?q=80&w=800&auto=format&fit=crop', desc: 'A beloved travellers\' lodge with a social café, vibrant notice boards, and easy lake access.' },
  { id: 3, name: 'Trek Stop Guesthouse', location: 'Sauraha, Chitwan', rating: 4.7, price: 25, amenities: ['Breakfast', 'Fan Rooms', 'Bicycle Hire'], image: 'https://images.unsplash.com/photo-1523987355523-c7b5b0dd90a7?q=80&w=800&auto=format&fit=crop', desc: 'Excellent value lodge steps from the jungle, with helpful staff and reliable safari bookings.' },
  { id: 4, name: 'Old Town Inn', location: 'Bhaktapur', rating: 4.8, price: 22, amenities: ['Durbar View', 'Free WiFi', 'Breakfast'], image: 'https://images.unsplash.com/photo-1566073771259-6a8506099945?q=80&w=800&auto=format&fit=crop', desc: 'Heritage-styled lodge with wooden window frames and views directly onto Bhaktapur\'s Durbar Square.' },
  { id: 5, name: 'Lakeside Homestay', location: 'Lakeside, Pokhara', rating: 4.5, price: 14, amenities: ['Home Cooking', 'Free WiFi', 'Garden'], image: 'https://images.unsplash.com/photo-1571896349842-33c89424de2d?q=80&w=800&auto=format&fit=crop', desc: 'A genuine Nepali family homestay offering home-cooked meals, warm conversation, and authentic cultural immersion.' },
  { id: 6, name: 'Namche Village Lodge', location: 'Namche Bazaar, Everest', rating: 4.9, price: 12, amenities: ['Mountain View', 'Dal Bhat', 'Hot Water'], image: 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=800&auto=format&fit=crop', desc: 'A legendary mountain lodge in the Sherpa capital with sweeping views of Everest and Ama Dablam.' },
];
