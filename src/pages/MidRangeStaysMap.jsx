...
const hotels = [
  { id: 1, name: 'Temple Tree Resort & Spa', location: 'Lakeside, Pokhara', lat: 28.2096, lng: 83.9587, rating: 4.7, price: 85, amenities: ['Pool', 'Spa', 'Free WiFi', 'Breakfast'], image: 'https://images.unsplash.com/photo-1571896349842-33c89424de2d?q=80&w=800&auto=format&fit=crop', desc: 'Elegant resort surrounded by tropical gardens with a beautiful outdoor pool and spa facilities.' },
  { id: 2, name: 'Begnas Lake Resort', location: 'Begnas, Pokhara', lat: 28.1800, lng: 84.0600, rating: 4.8, price: 95, amenities: ['Lake View', 'Kayaking', 'Restaurant', 'Free WiFi'], image: 'https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?q=80&w=800&auto=format&fit=crop', desc: 'A tranquil resort on the shores of the pristine Begnas Lake, far from the tourist crowds.' },
  { id: 3, name: 'Hotel Shanker', location: 'Lazimpat, Kathmandu', lat: 27.7177, lng: 85.3193, rating: 4.6, price: 90, amenities: ['Heritage Building', 'Pool', 'Free WiFi', 'Breakfast'], image: 'https://images.unsplash.com/photo-1566073771259-6a8506099945?q=80&w=800&auto=format&fit=crop', desc: 'A stunning Rana-era palace converted into a heritage hotel with modern comforts in central Kathmandu.' },
  { id: 4, name: 'Pavilions Himalayas', location: 'Pokhara Valley', lat: 28.2200, lng: 83.9800, rating: 4.9, price: 120, amenities: ['Mountain View', 'Pool', 'Farm-to-Table', 'Free WiFi'], image: 'https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?q=80&w=800&auto=format&fit=crop', desc: 'Award-winning eco-resort offering breathtaking Himalayan views, organic farm dining, and sustainable luxury.' },
  { id: 5, name: 'Green Park Hotel', location: 'Thamel, Kathmandu', lat: 27.7150, lng: 85.3100, rating: 4.5, price: 75, amenities: ['Free WiFi', 'Restaurant', 'Gym', 'Bar'], image: 'https://images.unsplash.com/photo-1555854877-bab0e564b8d5?q=80&w=800&auto=format&fit=crop', desc: 'A modern mid-range hotel in the heart of Thamel with a rooftop restaurant and well-equipped gym.' },
  { id: 6, name: 'Barahi Jungle Lodge', location: 'Chitwan', lat: 27.5740, lng: 84.4978, rating: 4.8, price: 110, amenities: ['Safari', 'Breakfast', 'River View', 'Pool'], image: 'https://images.unsplash.com/photo-1523987355523-c7b5b0dd90a7?q=80&w=800&auto=format&fit=crop', desc: 'Luxurious jungle lodge on the banks of the Rapti River — the ultimate Chitwan safari experience.' },
];
