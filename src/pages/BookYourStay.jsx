...
const hotels = [
  ...
  { id: 4, name: 'Hotel Holy Himalaya', location: 'Thamel, Kathmandu', rating: 4.5, price: 30, amenities: ['Free WiFi', 'Breakfast', 'City View'], image: 'https://upload.wikimedia.org/wikipedia/commons/f/fd/Basantapurpalace.JPG', desc: 'Well-located, clean and comfortable hotel with friendly staff and great access to sights.' },
  ...
  { id: 6, name: 'Sarangkot Mountain Lodge', location: 'Sarangkot, Pokhara', rating: 4.9, price: 55, amenities: ['Mountain View', 'Breakfast', 'Free WiFi'], image: 'https://upload.wikimedia.org/wikipedia/commons/9/9a/Pokhara_Valley.jpg', desc: 'Wake up to panoramic Himalayan sunrise views from this elevated mountain lodge.' },
];
